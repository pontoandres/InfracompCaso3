...
public class Cliente extends Thread {
    ...
    private String tiempoVerificaResponde = "";
    ...
    private void leerLlavePublicaRSA() {
        ...
        try {
            ...
            // System.out.println("La llave pública se leyó exitosamente desde
            // 'publico/llavePublica.key'.");
    ...
    private void pedirLlavesPublicas() {
        ...
        String firmaEsperada = "" + dh.prime.intValue() + ":" + dh.generator + ":"
                + dh.llaveCompartidaServidor.intValue();
    ...
    private void enviarConsultaPaquete(String paqueteId) {
        try {
            ...
            totalSum += (System.currentTimeMillis() - startTime);
            tiempoVerificaResponde = ("" + totalSum + "\n"); // tiempo verificar 
    ...
    public void generarArchivos() {
        String nombreCarpeta = "" + this.servidor.cantidadDelegados + "Delegados" + this.totClientes
                + "Cliente-Pruebas";
        ...
        generarArchivos(tiempoVerificaResponde, nombreCarpeta, "tiempoVerificaResponde");
    }
    ...
    public static void mismoCliente32Consultas(){
